<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    ...
    <ul class="nav navbar-right top-nav">
        <li class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i><?php if(isset($_SESSION['username']) && $_SESSION['role'] == 'admin'){echo $_SESSION['username'];}?><b class="caret"></b></a>
            <ul class="dropdown-menu">
                <li>
                    <a href="profile.php?username=<?php if (isset($_SESSION['username'])) {echo $_SESSION['username'];} ?>"><i class="fa fa-fw fa-user"></i> Profile</a> <!-- ! -->
                </li>
                <li>
